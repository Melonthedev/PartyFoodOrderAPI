...
document.getElementById("orderform").onsubmit = (event) => {
    ...
    fetch("/api/FoodOrder/AddFoodOrder", {
            ...
            .then(data => {
                if (data.status == 400) {
                    ...
                    <body>
                        ...
                        <button class="btn" style="width: 300px; max-width: 80%; margin-bottom: 30px; margin-top: 20px;" onclick="document.location = '/'">Noch etwas bestellen</button>
            ...
            }).catch(error => document.getElementById("errorlabel").innerText = "Der folgende Fehler ist während des ausführen deiner Bestellung aufgetreten: " +  error);
}