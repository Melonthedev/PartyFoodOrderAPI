    ...
    fetch("/api/FoodStock/AddProduct", {
        ...
        if (data.status == 400) {
            try {
                ...
                document.getElementById("errorlabel").innerHTML = "Folgender Fehler ist während der Bearbeitung deiner Anfrage aufgetreten: <br><strong><u>" + response.errors[Object.keys(response.errors)[0]] + "</u></strong><br>Bitte vergewissere dich, dass die ID deines Produktes noch nicht existiert.";
            } catch (error) {
                console.log(data)
